<style>
    ...
    .saml2-admin-wrapper { max-width: 1200px; margin: 0 auto; }
    ...
    .saml2-admin-wrapper input, .saml2-admin-wrapper textarea, .saml2-admin-wrapper select { width: 100%; padding: 0.5rem 0.75rem; border: 1px solid #d1d5db; border-radius: 0.375rem; font-size: 0.875rem; }
    ...
    .saml2-admin-wrapper .sp-item code { display: block; background: #f3f4f6; padding: 0.5rem; border-radius: 0.25rem; font-size: 0.75rem; word-break: break-all; margin-top: 0.25rem; }
